...
// Base path the site is served under (e.g. '/jcap'). Astro exposes this as
// BASE_URL with a trailing slash ('/jcap/'); we strip it so withBase('/x')
// gives '/jcap/x'. At the domain root it becomes '' and everything still works.
...
export const siteConfig = {
  name: 'Japan-Central Asia Young Professionals',
  nameJa: '日本・中央アジア ヤングプロフェッショナルズ',
  shortName: 'JCAP',
  // One-page brief (PDF). Empty = the download button is hidden.
  // Drop a file in public/downloads/ and set its path here to show it.
  onePageBriefUrl: '',
  aliases: [
    'Japan Central Asia Young Professionals',
    'Japan-Central Asia Youth Community',
    'Central Asian community in Japan',
    '日本 中央アジア 交流',
    '日本と中央アジアの交流コミュニティ',
    '在日 中央アジア コミュニティ',
  ],

  // Community sign-up form — joining JCAP, NOT an event registration.
