...
**Live:** https://ryumakojima.github.io/jcap/
**Repo (source + auto-deploy):** https://github.com/ryumakojima/jcap
...
This is a **project site**, so it's served from a subpath: `/jcap/`. That is set
by `base: '/jcap'` in `astro.config.mjs`. All internal links go through
