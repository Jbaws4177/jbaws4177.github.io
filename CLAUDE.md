# Japan-Central Asia Young Professionals (JCAP) — site

Bilingual (EN / 日本語) Astro static site for **Japan-Central Asia Young
Professionals (JCAP)** — a community connecting young people in Japan with the
Central Asian community living in Japan, via networking, culture, and sport.
Pre-launch (founded 2026; first event "Japan–Central Asia Connection Party",
around November 2026). Deploys to GitHub Pages as a **project site** at
`ryumakojima.github.io/jcap/`.
...
- Audience is broad: **all Central Asian countries**, and anyone in Japan into
  Central Asian culture/language/business/exchange. **Not students-only** —
  include young professionals, grads, entrepreneurs, and Central Asian
  residents in Japan.
...
- **Base path:** the site is served from `/jcap`, so every internal link/asset
...
## Deployment
**Live at https://ryumakojima.github.io/jcap/** (GitHub Pages **project** site,
repo `ryumakojima/jcap`, account `ryumakojima`). **Auto-deploy:** every push to
